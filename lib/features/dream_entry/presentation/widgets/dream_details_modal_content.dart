...
class _DreamDetailsModalContentState extends State<DreamDetailsModalContent> {
  ...
  Widget _buildTitleInput(ThemeData theme) {
    return Column(
      ...
      children: [
        _buildSectionTitle(theme, t.dreamEntry.dreamDetails.addDetails),
  ...
  Widget _buildTagsSection(ThemeData theme) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionTitle(theme, t.dreamEntry.tags.tags),
  ...
  Widget _buildMoodRatingSection(ThemeData theme) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionTitle(theme, t.dreamEntry.dreamDetails.moodRating),
        const SizedBox(height: 20),
        Container(
  ...
  Widget _buildConfirmButton(
      ThemeData theme, double bottomPadding, double bottomNavBarHeight) {
    return Container(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 32),
                    _buildMoodRatingSection(theme),
                  ],
                ),
              ),
            ),
            _buildConfirmButton(theme, bottomPadding, bottomNavBarHeight),
          ],
        ),
      ),
    );
