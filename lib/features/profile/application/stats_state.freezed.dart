...
abstract class $StatsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, Map<String, dynamic> stats, String? error});
}
...
class _$StatsStateImpl implements _StatsState {
  ...
  @override
  String toString() {
    return 'StatsState(isLoading: $isLoading, stats: $stats, error: $error)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, isLoading,
      const DeepCollectionEquality().hash(_stats), error);
...
abstract class _StatsState implements StatsState {
  const factory _StatsState(
      ...
      final String? error}) = _$StatsStateImpl;
